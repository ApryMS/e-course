                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('mentor-siswa.store') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label class="text-muted">Password (PASTISUKSES)</label>
                                                        <input type="password" id="password" name="password" class="form-control" readonly value="PASTISUKSES">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" id="no_ortu" name="no_ortu" class="form-control" value="{{ old('no_ortu') }}" required>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="province"  class="text-muted d-block">Provinsi</label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="regency1"  class="text-muted d-block">Kabupaten</label>
